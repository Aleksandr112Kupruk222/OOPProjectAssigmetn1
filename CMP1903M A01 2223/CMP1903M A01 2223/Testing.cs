...
namespace CMP1903M_A01_2223
{
    internal class Testing
    {
        public Testing()
        {
            ...
            val = validation.IntValidation("Deck of cards has been created. \nHow would you like to shuffle it? \n1.Fisher-Yates Shuffle \n2.Riffle Shuffle\n3.No shuffle", 0, 3);
            ...
            if (isShuffled == true)
            {
                choice = validation.IntValidation("1.Deal one card.\n2.Deal specified amount of cards", 0, 2);
                ...
                {
                    amount = validation.IntValidation("Please state the amount of cards to deal", 0, 52);
